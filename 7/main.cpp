#include <iostream>
using namespace std;
//7. Leia uma matriz de 3 x 3 elementos. Calcule a soma dos elementos que estão abaixo da diagonal principal.
...
{   //bibioteca para o programa ler em português
    ...
    //mostrar a abaixo acima da diagonal da matriz
    cout << "\nSoma abaixo da diagonal principal é " << soma << endl;
