#include <iostream>
using namespace std;
//5. Leia uma matriz de 3 x 3 elementos. Calcule a soma dos elementos que estão na diagonal principal
...
{   //bibioteca para o programa ler em português
    ...
    //mostrar a soma da diagonal da matriz
    cout << "\nSoma da diagonal principal é " << soma << endl ;
